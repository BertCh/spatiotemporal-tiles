...
- [`d5163aa`](https://github.com/BertCh/spatiotemporal-tiles/commit/d5163aab712f83c0a45b428089b11f9b83bc8b94) Thanks [@BertCh](https://github.com/BertCh)! - Packed `formatVersion: 3` — tiles are addressed by variant, not just by `(z,x,y,t)`
...
- [`2c020da`](https://github.com/BertCh/spatiotemporal-tiles/commit/2c020dac959f4acdd99b3171a645fcc63077ccd0) Thanks [@BertCh](https://github.com/BertCh)! - Packed format v1 is gone
...
- [`a7b57dc`](https://github.com/BertCh/spatiotemporal-tiles/commit/a7b57dc13db321c72fee68fb0110e9cd8347c1ce) Thanks [@BertCh](https://github.com/BertCh)! - Tile payloads are re-encoded — rebuild and republish every archive
...
- [`d5163aa`](https://github.com/BertCh/spatiotemporal-tiles/commit/d5163aab712f83c0a45b428089b11f9b83bc8b94) Thanks [@BertCh](https://github.com/BertCh)! - Removed: `emitGLSL300` (and Cesium's `timeFilterAlphaGlsl` wrapper)
...
- [`2a58eb4`](https://github.com/BertCh/spatiotemporal-tiles/commit/2a58eb4ce26d7921c4b9832149f5dd11987fe148) Thanks [@BertCh](https://github.com/BertCh)! - One `STT` prefix for every layer class, so nothing shadows deck.gl
