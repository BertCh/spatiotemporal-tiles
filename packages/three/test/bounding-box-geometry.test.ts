// Regression: the STTBoundingBoxLayer's edge + velocity LineSegments must ALWAYS
...
describe('STTBoundingBoxLayer geometry seeding', () => {
  it('seeds a position attribute on the edges geometry at construction (0 active boxes)', () => {
    const layer = new STTBoundingBoxLayer({ id: 'objects' });
