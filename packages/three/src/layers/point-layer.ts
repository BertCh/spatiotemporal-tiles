...
/**
 * `STTPointLayer` — the Three port of deck's `AnimatedPointLayer` for the AV
...
export interface STTPointLayerOptions extends ThreeTimeWindowOptions {
  id?: string;
...
export class STTPointLayer extends BaseSTTLayer implements STTIdPickable {
  readonly id: string;
  ...
  constructor(options: STTPointLayerOptions = {}) {
    super();
