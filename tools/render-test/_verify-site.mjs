...
const PAGES = [
  ...
  { name: "docs-api-point-layer", path: "/docs/api/animated-point-layer", wait: 2500 },
  { name: "docs-system-overview", path: "/docs/architecture/system-overview", wait: 6000 },
  { name: "docs-cli-reference", path: "/docs/api/cli-reference", wait: 2500 },
  { name: "docs-manifest-schema", path: "/docs/spec/manifest-schema", wait: 2000 },
  { name: "docs-404", path: "/docs/nope/missing", wait: 1000 },
  { name: "fullscreen-drifters", path: "/demo/ocean-drifters", wait: 9000 },
  { name: "fullscreen-od-summary", path: "/demo/nyc-taxi-od-summary", wait: 9000 },
...
await page.goto(`${BASE}/docs/api/animated-point-layer`, { waitUntil: "domcontentloaded" });
