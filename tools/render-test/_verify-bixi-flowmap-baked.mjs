...
await page.goto(`${BASE}/demo/bixi-flowmap-baked`, { waitUntil: "domcontentloaded", timeout: 30000 });
...
const packFetches = [...dataReqs.entries()].filter(([k]) => k.includes("packs/"));
...
console.log("\n=== verdict ===");
console.log(`  rendered (lit on load + during play): ${rendered}  [onload ${onLoad.litPct}, play ${lit.join(", ")}]`);
