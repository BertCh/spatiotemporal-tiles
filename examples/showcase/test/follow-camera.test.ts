...
describe("shortestAngleDelta", () => {
  ...
  it("stays within [-180, 180)", () => {
    for (const [a, b] of [[0, 179], [0, 181], [0, 180], [270, 5]]) {
...
describe("desiredCameraAt", () => {
  ...
  it("emits a travel-direction bearing when rotateToHeading is on", () => {
    const cfg: FollowCameraConfig = { ...DEFAULT_FOLLOW_CONFIG, rotateToHeading: true };
  ...
  it("pins zoom and look-ahead when configured", () => {
    const cfg: FollowCameraConfig = { ...DEFAULT_FOLLOW_CONFIG, zoom: 17, leadMs: 500 };
